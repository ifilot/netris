/**************************************************************************
 *   font_writer.cpp  --  This file is part of Netris.                    *
 *                                                                        *
...
FontWriter::CharacterAtlas::CharacterAtlas(const std::string& font_file, unsigned int _pt, float _width, float _edge,
        std::shared_ptr<Shader> _shader, unsigned int _cstart, unsigned int _ccount) {
...
void FontWriter::CharacterAtlas::write_text(float x, float y, float z, const glm::vec3& color, const std::string& line) {
    ...
    this->shader->set_uniform(1, &color[0]);
    this->shader->set_uniform(2, NULL); // load texture id
    this->shader->set_uniform(3, &this->sdf_width);
    this->shader->set_uniform(4, &this->sdf_edge);
    ...
    do {
        ...
        this->shader->set_uniform(0, &mvp[0][0]);
